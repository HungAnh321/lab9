<?php
          ...
          $mail = new PHPMailer\PHPMailer\PHPMailer(true);  //true: enables exceptions
		    ...
		    $nguoigui = 'hungtk.21it@vku.udn.vn';
		    $matkhau = 'xscjfqfastsqkram';// mật khẩu ứng dụng đã tạo ở bước 3
    ...
    $email_array = explode(",",$recipients);*/
                ...
                $mail->AddAttachment("A37TT2142021.jpg","picture");
